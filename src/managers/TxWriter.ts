...
import { InMemoryRetryStore } from '../stores';
import {
    ConceroNetwork,
    ILogger,
    INonceManager,
...
export class TxWriter implements ITxWriter {
    ...
    public async callContract(
        ...
        if (this.config.dryRun) {
            ...
            return {
                transactionHash: `0xdry${Date.now().toString(16)}`,
            } as WaitForTransactionReceiptReturnType;
        }

        return await callContract(publicClient, walletClient, params, this.nonceManager, {
